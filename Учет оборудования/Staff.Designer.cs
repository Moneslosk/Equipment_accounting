namespace Учет_оборудования
{
	partial class Staff
	{
		...
		private void InitializeComponent()
		{
            ...
            // idd_СкладаLabel
            // 
            resources.ApplyResources(idd_СкладаLabel, "idd_СкладаLabel");
            idd_СкладаLabel.BackColor = System.Drawing.Color.Transparent;
            idd_СкладаLabel.Name = "idd_СкладаLabel";
            // 
            // номер_паспортаLabel
            // 
            resources.ApplyResources(номер_паспортаLabel, "номер_паспортаLabel");
            ...
            // должностьLabel
            // 
            resources.ApplyResources(должностьLabel, "должностьLabel");
            должностьLabel.BackColor = System.Drawing.Color.Transparent;
            должностьLabel.Name = "должностьLabel";
            // 
            // адрес_сотрудникаLabel
            // 
            resources.ApplyResources(адрес_сотрудникаLabel, "адрес_сотрудникаLabel");
            ...
            resources.ApplyResources(this.сотрудникиBindingNavigator, "сотрудникиBindingNavigator");
            ...
            resources.ApplyResources(this.должностьTextBox, "должностьTextBox");
